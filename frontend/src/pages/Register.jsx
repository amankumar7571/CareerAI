      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-secondary/30 border-l border-border p-12">
        <div className="max-w-md">
          <blockquote className="text-xl text-foreground mb-6 text-balance">
            {"\"CareerAI transformed my job search. The AI analysis was incredibly accurate and the roadmap helped me land my dream role.\""}
          </blockquote>
          <div>
            <div className="font-medium text-foreground">Alex Martinez</div>
